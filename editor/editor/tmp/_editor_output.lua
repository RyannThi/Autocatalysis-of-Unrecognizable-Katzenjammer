...
_editor_class["Boss"]=boss.define("Boss","Name",240,384,spellcard_background,"All",nil,nil)
...
function _tmp_sc:init()
    lasttask=task.New(self,function()
        task._Wait(60)
        _create_bullet_group(arrow_big,COLOR_RED,self.x,self.y,5,0,3,4,0,0,true,0,true,true,0,false,self)
    end)
end
